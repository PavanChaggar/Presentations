...
\pgfdeclareimage[width=\paperwidth]{titlebackground}{background_imgs/title-slide-background.png}
...
\pgfdeclareimage[width=0.9cm]{oxfordlogo}{background_imgs/oxford-logo.png}
\pgfdeclareimage[width=1cm]{mathslogo}{background_imgs/mathematics-logo.png}
...
\title[Viva Presentation]{Mathematical Models and Inference for Neurodegenerative Disorders} % short title for footer
\author%
{%
    \sc{Pavan Chaggar}\\
    \textit{DPhil Student}
...
\date[PoM2015]{December 2020} % short date for footer
